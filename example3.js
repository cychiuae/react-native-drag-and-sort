...
const ReactMotion = {Motion, spring} = require("react-motion");
          ...
          <Motion
            ...
            {({position,top,width,scale,backgroundColor}) => {
              let ss = {
                ...
                width,
                // top: top.val,
                transform: [{translateX: Math.ceil(top-0.5)},{scale: scale}],
              };
      ...
      <View style={css.container}>
        ...
        */}
        ...
        <ScrollView ref="scrollView" scrollEnabled={scrollEnabled}
          ...
          <View style={[css.list,{height: contentHeight, flexDirection: 'row'}]}
